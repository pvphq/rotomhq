  ...
  if (message.channel.id === "747664537699876927") {
    if (
      ...
      const filter = (reaction, blackmirrorleader) => {
        return (
          ...
          (blackmirrorleader.id === "496704628457603072" ||
            blackmirrorleader.id === "647326966999154688" ||
      ...
      const filter = (reaction, sacredleader) => {
        return (
          ...
          (sacredleader.id === "623026756701650946" ||
            ...
            sacredleader.id === "518856827308474399" ||
      ...
      const filter = (reaction, blackmirrorleader) => {
        return (
          ...
          (blackmirrorleader.id === "349390345966059531" ||
            blackmirrorleader.id === "642980180993769473" ||
      ...
      const filter = (reaction, blackmirrorleader) => {
        return (
          ["✅"].includes(reaction.emoji.name) &&
          (blackmirrorleader.id === "643331768228773899" ||
